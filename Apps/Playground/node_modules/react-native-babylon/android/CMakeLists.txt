...
# Ideally this would happen automatically as part of consuming the jsi lib, but it seems like the jsi CMakeLists.txt isn't setup quite right.
# Created a PR to fix this: https://github.com/facebook/hermes/pull/207
include_directories(
    ${REACTNATIVE_DIR}/ReactCommon/jsi
)
