...
namespace Babylon
{
    ...
    Native::Native(facebook::jsi::Runtime* jsiRuntime, CFRunLoopRef jsRunLoop, void* windowPtr, size_t width, size_t height)
...
//        }};
        ...
        m_impl->runtime->Dispatch([this, windowPtr, width, height](Napi::Env env){
